            ...
            <div class="row">
                <div class="col-6">
                    <div class="bestel-form">
                        ...
                        <input name="naam" required type="naam" class="form-control" id="inputNaam" aria-describedby="naamHelp" autofocus>
                ...
                <div class="col-6">
                    <div class="bestel-form">
                        ...
                        <input name="achternaam" required type="achternaam" class="form-control" id="inputAchternaam" aria-describedby="AchternaamHelp">
                ...
                <div class="col-6">
                    <div class="bestel-form">
                        ...
                        <input name="emailadres" required type="emailadres" class="form-control" id="inputEmailadres" aria-describedby="emailadresHelp" autofocus>
                ...
                <div class="col-6">
                    <div class="bestel-form">
                        ...
                        <input name="telefoonnummer" required type="telefoonnummer" class="form-control" id="inputTelefoonnummer" aria-describedby="TelefoonnummerHelp">
            ...
            <div class="row">
                <div class="col-6">
                    <div class="bestel-form">
                        ...
                        <input name="postcode" required type="postcode" class="form-control" id="inputPostcode" aria-describedby="postcodeHelp" autofocus>
